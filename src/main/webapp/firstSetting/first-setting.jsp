...
<main class="form-first w-100 m-auto flex-shrink-0">
       ...
       <form action="FirstSetting.action" method="post">
		...
		<button type="button" class="w-100 btn btn-warning btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#termsModal" id="termsLink">
			 利用規約を確認する
		</button>
		...
		<button type="button" class="w-100 btn btn-warning btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#privacyModal" id="privacyLink">
		    プライバシーポリシーを確認する
		</button>
