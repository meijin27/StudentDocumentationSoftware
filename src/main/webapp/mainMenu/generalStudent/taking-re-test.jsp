		...
		<form action="TakingReTest.action" method="post" autocomplete="off">
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-12 mb-5">
	                ...
	                <span class="required-label">必須</span>
	                <input class="form-control ${not empty requestScope['reasonError'] ? 'error-input' : ''}" type="text" id="reason" name="reason" placeholder="勉強不足のため" value="<c:out value='${reason}'/>" required>
		        	<!-- エラー表示  -->
