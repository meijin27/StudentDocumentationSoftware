		...
		<form action="PeriodUpdateSecond.action" method="post">
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-12 mb-3">
  	 	        ...
  	 	        <!-- 期間年月日（自） -->
	            <p class="form-label">期間（自）(Period from)</p>
	            <div class="col-md-6 mb-3">
	            ...
	            <div class="col-md-6 mb-3">
  	            ...
  	            <!-- 期間年月日（至） -->
   	            <p class="form-label">期間（至）(Period to)</p>
	            <div class="col-md-6 mb-3">
