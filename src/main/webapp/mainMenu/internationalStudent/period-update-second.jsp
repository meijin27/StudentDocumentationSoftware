		...
		<form action="PeriodUpdateSecond.action" method="post" autocomplete="off">
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-6 mb-3">
	                ...
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="testName" name="testName" placeholder="日本語能力検定試験" value="<c:out value='${testName}'/>">
	            </div>   	            
   	            <!-- 級又は点数 -->
	            <div class="col-md-6 mb-3">
	                <label class="form-label" for="attainedLevelOrScore">級又は点数（Attained level or score）</label>
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="attainedLevelOrScore" name="attainedLevelOrScore" placeholder="１級" value="<c:out value='${attainedLevelOrScore}'/>">
	            </div>
	            ...
	            <div class="col-md-12 mb-3">
	                ...
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="organization" name="organization" placeholder="日本語学校　希望ヶ丘駅前支店" value="<c:out value='${organization}'/>" >
	            </div>
  	 	        <!-- 期間年月日（自） -->
                <label class="form-label" for="startYear">期間（自）(Period from)</label>
	            <div class="col-md-6 mb-3">
	                <select id="startYear" name="startYear" class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''} select-center auto-select" data-selected-value="<c:out value='${param.startYear}'/>" >
	            ...
	            <div class="col-md-6 mb-3">
	                <select id="startMonth" name="startMonth" class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''} select-center auto-select" data-selected-value="<c:out value='${param.startMonth}'/>" >
	            ...
	            <div class="col-md-6 mb-3">
	                <select id="endYear" name="endYear" class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''} select-center auto-select" data-selected-value="<c:out value='${param.endYear}'/>" >
	                    <option value="">-- 年 --</option>
	            ...
	            <div class="col-md-6 mb-3">
	                <select id="endMonth" name="endMonth" class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''} select-center auto-select" data-selected-value="<c:out value='${param.endMonth}'/>" >
	                    <option value="">-- 月 --</option>
	                    <% for(int i=1; i <=12; i++){ %>
	                        <option value="<%= i %>">
	                            <%= i %>月
	            ...
	            <div class="col-md-12 mb-3">
	                ...
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="others" name="others" placeholder="2010年から2018年まで日本で生活しており、小学校も日本の学校に通っていた。" value="<c:out value='${others}'/>">
	            </div> 
	            ...
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="self" name="self" placeholder="100,000" value="<c:out value='${self}'/>">
	            </div>
	            <div class="col-md-8 mb-3"></div>	      
   	            <!-- 在外経費支弁者負担 -->
                <label class="form-label" for="supporterLivingAbroad">②在外経費支弁者負担（Supporter living abroad）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterLivingAbroad" name="supporterLivingAbroad" placeholder="50,000" value="<c:out value='${supporterLivingAbroad}'/>">
	            </div>
	            <div class="col-md-8 mb-3"></div>	      
   	            <!-- 在日経費支弁者負担 -->
                <label class="form-label" for="supporterInJapan">③在日経費支弁者負担（Supporter in Japan）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterInJapan" name="supporterInJapan" placeholder="80,000" value="<c:out value='${supporterInJapan}'/>">
	            </div>
	            <div class="col-md-8 mb-3"></div>	      
   	            <!-- 奨学金 -->
                <label class="form-label" for="scholarship">④奨学金（Scholarship）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="scholarship" name="scholarship" placeholder="30,000" value="<c:out value='${scholarship}'/>">
	            </div>
	            <div class="col-md-8 mb-3"></div>	      
   	            <!-- その他 -->
                <label class="form-label" for="otherDisbursement">⑤その他（Others）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="otherDisbursement" name="otherDisbursement" placeholder="20,000" value="<c:out value='${otherDisbursement}'/>">
	            </div>	            
	            <div class="col-md-8 mb-3"></div>	      
      			<p class="border-bottom"></p>	            
	            ...
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="carryingAbroad" name="carryingAbroad" placeholder="2,350,000/年" value="<c:out value='${carryingAbroad}'/>">
	            </div>	  			
	            <div class="col-md-8 mb-3"></div>	      
	            <!-- 携行者 -->
                <label class="form-label" for="carryingName">携行者（Name of the individual carrying cash）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="carryingName" name="carryingName" placeholder="ジョン・スミス" value="<c:out value='${carryingName}'/>">
	            </div>	  	
	            <div class="col-md-8 mb-3"></div>	      
	            <!-- 携行時期 -->	 
                <label class="form-label" for="carryingTime">携行時期（Date and time of carrying cash）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="carryingTime" name="carryingTime" placeholder="2020年頃" value="<c:out value='${carryingTime}'/>">
	            </div>	  	
	            <div class="col-md-8 mb-3"></div>	      
 	            <!-- 外国からの送金 -->
                <label class="form-label" for="remittancesAbroad">②外国からの送金（Remittances from abroad）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="remittancesAbroad" name="remittancesAbroad" placeholder="200,000/月" value="<c:out value='${remittancesAbroad}'/>">
	            </div>	  			  		
	            <div class="col-md-8 mb-3"></div>	      
 	            <!-- その他の送金 -->
                <label class="form-label" for="otherRemittances">③その他（Others）</label>
	            <div class="col-md-4 mb-3">
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="otherRemittances" name="otherRemittances" placeholder="" value="<c:out value='${otherRemittances}'/>">
	            </div>	  			
	            <div class="col-md-8 mb-3"></div>	      
      			<p class="border-bottom"></p>	            
	            ...
	            <div class="col-md-6 mb-3">
	                ...
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterName" name="supporterName" placeholder="有澤　宗一郎" value="<c:out value='${supporterName}'/>">
	            </div>	  
 	            <!--  経費支弁者住所 -->
	            <div class="col-md-6 mb-3">
	                <label class="form-label" for="supporterAddress">経費支弁者住所(Supporter Address)</label>
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterAddress" name="supporterAddress" placeholder="京都府京都市四条通４－２" value="<c:out value='${supporterAddress}'/>">
	            </div>	  
 	            <!-- 経費支弁者電話番号 -->
	            <div class="col-md-6 mb-3">
	                <label class="form-label" for="supporterTel">経費支弁者電話番号(Supporter Tel)</label>
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterTel" name="supporterTel" placeholder="03-1234-5678" value="<c:out value='${supporterTel}'/>">
	            </div>	  
  	            <!-- 経費支弁者年収 -->
	            <div class="col-md-6 mb-3">
	                <label class="form-label" for="supporterIncome">経費支弁者年収(Supporter Annual income)</label>
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterIncome" name="supporterIncome" placeholder="5600000" value="<c:out value='${supporterIncome}'/>">
	            </div>	  
  	            <!-- 経費支弁者勤務先 -->
	            <div class="col-md-6 mb-3">
	                <label class="form-label" for="supporterEmployment">経費支弁者勤務先(Supporter place of employment)</label>
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterEmployment" name="supporterEmployment" placeholder="有澤重工業株式会社" value="<c:out value='${supporterEmployment}'/>">
	            </div>	  
  	            <!-- 経費支弁者勤務先電話番号 -->
	            <div class="col-md-6 mb-5">
	                <label class="form-label" for="supporterWorkTel">経費支弁者勤務先電話番号(Supporter Work Phone Number)</label>
	                <input class="form-control ${not empty requestScope['Error'] ? 'error-input' : ''}" type="text" id="supporterWorkTel" name="supporterWorkTel" placeholder="0120-55-9876" value="<c:out value='${supporterWorkTel}'/>">
	            </div>	 
	        </div>    
		    <!-- トークンの格納  -->
