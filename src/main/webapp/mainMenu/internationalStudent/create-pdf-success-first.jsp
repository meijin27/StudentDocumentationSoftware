...
<main class="form-mainMenu col-md-9 ms-sm-auto col-lg-10  w-100 m-auto flex-shrink-0 px-md-4 mt-5">
	<div class="container">
		...
		<a href="<%=request.getContextPath()%>/mainMenu/internationalStudent/period-update-second.jsp" class="w-100 btn btn-lg btn-success mb-3">2枚目作成画面へ移行（Move to the screen for creating the second sheet）</a>
